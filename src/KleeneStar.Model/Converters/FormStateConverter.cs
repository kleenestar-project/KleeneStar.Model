...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed form state objects for use in RESTful
    /// operations.
    /// </summary>
    public class FormStateConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                if (id == FormState.Archived.Id())
                {
                    return FormState.Archived;
                }
        ...
        public object ToRaw(object value, Type sourceType)
        {
            return value switch
            {
                FormState.Archived => FormState.Archived.Id(),
                _ => FormState.Active.Id()
            };
        }
    }
}
