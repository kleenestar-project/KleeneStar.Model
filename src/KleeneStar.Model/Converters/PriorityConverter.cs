...
{
    /// <summary>
    /// Provides methods to convert between raw values and strongly typed priority entities for REST operations.
    /// </summary>
    public class PriorityConverter : IRestValueConverter
    {
        /// <summary>
