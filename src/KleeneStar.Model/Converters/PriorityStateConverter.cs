...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed priority state objects for use in RESTful
    /// operations.
    /// </summary>
    public class PriorityStateConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                if (id == PriorityState.Archived.Id())
                {
                    return PriorityState.Archived;
                }
        ...
        public object ToRaw(object value, Type sourceType)
        {
            return value switch
            {
                PriorityState.Archived => PriorityState.Archived.Id(),
                _ => PriorityState.Active.Id()
            };
        }
    }
}
