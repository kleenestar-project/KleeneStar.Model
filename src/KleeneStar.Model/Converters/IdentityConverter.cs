...
{
    /// <summary>
    /// Provides identity conversion functionality for REST value conversion operations.
    /// </summary>
    public class IdentityConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                //return ids
                //    .Select(id => CoreHub.IdentityManager?.GetIdentity(id))
