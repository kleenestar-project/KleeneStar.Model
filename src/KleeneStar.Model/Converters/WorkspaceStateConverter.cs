...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed workspace state objects for use in RESTful
    /// operations.
    /// </summary>
    public class WorkspaceStateConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                if (id == WorkspaceState.Archived.Id())
                {
        ...
        public object ToRaw(object value, Type sourceType)
        {
            return value switch
            {
                WorkspaceState.Archived => WorkspaceState.Archived.Id(),
                _ => WorkspaceState.Active.Id()
            };
        }
    }
}
