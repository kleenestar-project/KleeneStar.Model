...
{
    /// <summary>
    /// Provides methods for converting between raw values and workspace-related types for REST operations.
    /// </summary>
    public class WorkspaceConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                //return ids
                //    .Select(id => CoreHub.WorkspaceManager?.GetWorkspace(id))
