...
{
    /// <summary>
    /// Provides methods to convert workflow-related values between their raw representations and strongly typed objects
    /// for use in RESTful APIs.
    /// </summary>
    public class WorkflowConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                //return ids
                //    .Select(id => CoreHub.WorkflowManager?.GetWorkflow(id))
