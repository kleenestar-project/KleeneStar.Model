...
{
    /// <summary>
    /// Provides methods for converting objects between raw representations and strongly typed values for RESTful
    /// operations.
    /// </summary>
    public class ObjectConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                //return ids
                //    .Select(id => CoreHub.ObjectManager?.GetObject(id))
