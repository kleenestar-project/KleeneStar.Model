...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed field state objects for use in RESTful
    /// operations.
    /// </summary>
    public class FieldStateConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                if (id == FieldState.Archived.Id())
                {
                    return FieldState.Archived;
                }
        ...
        public object ToRaw(object value, Type sourceType)
        {
            return value switch
            {
                FieldState.Archived => FieldState.Archived.Id(),
                _ => FieldState.Active.Id()
            };
        }
    }
}
