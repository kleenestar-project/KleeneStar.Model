...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed group objects for REST
    /// operations.
    /// </summary>
    public class GroupConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                //return ids
                //    .Select(id => CoreHub.GroupManager?.GetGroup(id))
