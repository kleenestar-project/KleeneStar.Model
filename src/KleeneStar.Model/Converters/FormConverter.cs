...
{
    /// <summary>
    /// Provides methods for converting between raw values and strongly typed form representations for use in RESTful
    /// operations.
    /// </summary>
    public class FormConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                //return ids
                //    .Select(id => CoreHub.FormManager?.GetForm(id))
