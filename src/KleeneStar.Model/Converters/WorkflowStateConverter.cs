...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed workflow state objects for use in RESTful
    /// operations.
    /// </summary>
    public class WorkflowStateConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                if (id == WorkflowState.Archived.Id())
                {
        ...
        public object ToRaw(object value, Type sourceType)
        {
            return value switch
            {
                WorkflowState.Archived => WorkflowState.Archived.Id(),
                _ => WorkflowState.Active.Id()
            };
        }
    }
}
