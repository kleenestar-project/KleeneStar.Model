...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed FieldCardinality
    /// values for use in RESTful operations.
    /// </summary>
    public class FieldCardinalityConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                if (id == FieldCardinality.Multiple.Id())
                {
                    return FieldCardinality.Multiple;
                }
        ...
        public object ToRaw(object value, Type sourceType)
        {
            return value switch
            {
                FieldCardinality.Multiple => FieldCardinality.Multiple.Id(),
                _ => FieldCardinality.Single.Id()
            };
        }
    }
}
