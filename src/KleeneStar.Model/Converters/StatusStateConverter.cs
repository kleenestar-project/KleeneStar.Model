...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed status state objects for use in RESTful
    /// operations.
    /// </summary>
    public class StatusStateConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                if (id == StatusState.Archived.Id())
                {
                    return StatusState.Archived;
                }
        ...
        public object ToRaw(object value, Type sourceType)
        {
            return value switch
            {
                StatusState.Archived => StatusState.Archived.Id(),
                _ => StatusState.Active.Id()
            };
        }
    }
}
