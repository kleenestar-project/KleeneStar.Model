...
{
    /// <summary>
    /// Provides methods to convert tenant-related values between their raw representations and strongly typed objects
    /// for use in RESTful APIs.
    /// </summary>
    public class TenantConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                //return ids
                //    .Select(id => CoreHub.TenantManager?.GetTenant(id))
