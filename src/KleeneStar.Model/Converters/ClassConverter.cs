...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed class objects for use in RESTful
    /// operations.
    /// </summary>
    public class ClassConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object FromRaw(object rawValue, Type targetType)
        {
            ...
            if (rawValue is string s)
            {
                ...
                //return ids
                //    .Select(id => ModelHub.GetClasses(id))
