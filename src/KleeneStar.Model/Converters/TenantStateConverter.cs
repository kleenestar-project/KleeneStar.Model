...
{
    /// <summary>
    /// Provides methods to convert between raw data representations and strongly typed tenant state objects for use in RESTful
    /// operations.
    /// </summary>
    public class TenantStateConverter : IRestValueConverter
    {
        /// <summary>
        ...
        public object ToRaw(object value, Type sourceType)
        {
            return value switch
            {
                TenantState.Archived => TenantState.Archived.Id(),
                _ => TenantState.Active.Id()
            };
        }
    }
}
